...
function createFaces(vertIdx1, vertIdx2, flipped=false){
    var faces = [];
    ...
    var face, face_1, face_2;
    for (var num=0;num<total-1;num++){
        if(flipped){
            if (fan){
                face = new THREE.Face3(vertIdx2[num], vertIdx1[0], vertIdx2[num+1] );
                faces.push(face) ; 
            }
            else{
                face_1 = new THREE.Face3( vertIdx1[num], vertIdx1[num+1], vertIdx2[num]  );
                face_2 = new THREE.Face3( vertIdx2[num+1], vertIdx2[num], vertIdx1[num+1]  );
                faces.push(...[face_1, face_2]);
            }
        }
        else{
            if ( fan ){
                face = new THREE.Face3(vertIdx1[0], vertIdx2[num], vertIdx2[num+1] );
                faces.push(face) ; 
            }
            else{
                face_1 = new THREE.Face3( vertIdx1[num], vertIdx1[num+1], vertIdx2[num]  );
